...
<div class="wrap">
    ...
    <div class="clearfix layout">
        ...
        <!--<div class="clearfix layout">-->
            <!--<h1><a href="/htb/index.php/Home/accountmanage/userManage">交易管理系统</a></h1>-->
            <!--<div>-->
                <!--<a href="/htb/index.php/Home/accountmanage/orgManage">账户管理</a>-->
    ...
    <div class="main">
        <div class="sidebar">
            <a href="/htb/index.php/Home/clientmanage/clientList">客户列表</a>
            <a href="/htb/index.php/Home/clientmanage/chiCangSearch">持仓查询</a>
            <a href="/htb/index.php/Home/clientmanage/pingCangSearch">平仓查询</a>
            <a href="/htb/index.php/Home/clientmanage/chuJinSearch" class="active">出金查询</a>
