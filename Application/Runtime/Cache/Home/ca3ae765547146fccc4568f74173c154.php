    ...
    <!--<div class="header">-->
        <!--<div class="clearfix layout">-->
            ...
            <!--<div>-->
                ...
                <!--<a href="/index.php/Home/countmanage/countTable"  class="active">结算管理</a>-->
                <!--<a href="/index.php/Home/sysmanage/pwdManage">系统管理</a>-->
            <!--</div>-->
        <!--</div>-->
    <!--</div>-->
    <div class="main">
        <div class="sidebar"><a href="/index.php/Home/countManage/countTable" class="active">统计报表</a>
        ...
        <div class="content">
            ...
            <div class="search-bar">时间:
                ...
                <a href="javascript:;" data-link="/index.php/Home/trade/exceFile" class="btn J_exl">导出EXL</a>
            </div>
