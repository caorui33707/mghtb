...
<html>
  <head>
    ...
    <title></title>
    <link rel="stylesheet" href="/hkxt/Public/template/assets/css/login.min.css">
  </head>
  <body>
    <div class="wrap">
      <div class="main">
    ...
    <script src="/hkxt/Public/template/assets/js/vendor/require.js" data-main="/hkxt/Public/template/assets/js/common"></script>
    <script>
